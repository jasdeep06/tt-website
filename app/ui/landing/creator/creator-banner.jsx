    ...
    return(
        <div className="text-white flex flex-col p-5" style={{
          ...
          ref={ref}>
            ...
            <p className="md:text-xl text-lg my-2 self-center">Supercharge your reach with <span className="md:text-3xl font-bold">DUBBING</span> accompanied by <span className="md:text-3xl font-bold">SCREEN TRANSLATION</span> and magical <span className="md:text-3xl font-bold">LIP SYNC</span>!</p>
            <div className="md:flex md:flex-row flex-col mt-14 gap-3">
                <MuxPlayer src={vid} />
                ...
                <div className="md:flex md:flex-wrap md:justify-around hidden">
